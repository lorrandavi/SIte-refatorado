...
function App() {
  return (
    <div className="bg-arrakis-base min-h-screen relative overflow-x-hidden selection:bg-arrakis-spice selection:text-black">
      ...
      <main className="max-w-6xl mx-auto px-6 w-full pb-0">
        <Hero />
        ...
        <footer className="py-12 text-center text-arrakis-sand/30 font-mono text-xs uppercase tracking-widest border-t border-arrakis-gold/10">
